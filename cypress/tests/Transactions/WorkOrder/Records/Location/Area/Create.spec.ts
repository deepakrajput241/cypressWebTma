...
function fillRequiredFields() {
  cy.fillSelect("Location Type", "Area");
...
describe("create Work Order for Location of type Area", () => {
  beforeEach(() => {
    cy.login(Cypress.env("user1"));
    cy.visit("/#!/WorkOrder/Create");
  });

  it("should not create Work Order for Location of type Area without required fields", () => {
  ...
  it(
    "should create Work Order for Location of type Area, and then delete it",
    { tags: "@smoke" },
    () => {
      fillRequiredFields();
