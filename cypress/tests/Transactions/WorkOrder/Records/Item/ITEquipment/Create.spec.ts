...
describe(
  "should create Work Order for Item of type IT Equipment",
  { tags: "@smoke" },
  () => {
    beforeEach(() => {
    ...
    it("should not create Work Order for Item of type IT Equipment when missing required fields", () => {
      // missing 'Item Code'
      cy.get("span[ng-bind='WindowTitle']:contains('Work Order')").should(
        "be.visible"
      );
      cy.fillSelect("Item Type", "IT Equipment");
      ...
      cy.fillCombobox("Item Code", data.itEquipmentID);
      cy.wait(500);
    ...
    it.skip("should create Work Order for Item of type IT Equipment with required fields, and then delete", () => {
      cy.get("span[ng-bind='WindowTitle']:contains('Work Order')").should(
        "be.visible"
      );
      cy.fillSelect("Item Type", "IT Equipment");
