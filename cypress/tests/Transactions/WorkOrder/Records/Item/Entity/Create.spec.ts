...
describe(
  "should create Work Order for Item of type Entity",
  { tags: "@smoke" },
  () => {
    beforeEach(() => {
    ...
    it("should not create Work Order for Item of type Entity when missing required fields", () => {
      // missing 'Item Code'
      cy.get("span[ng-bind='WindowTitle']:contains('Work Order')").should(
        "be.visible"
      );
      cy.fillSelect("Item Type", "Entity");
      ...
      cy.fillSelect("Item Type", "Entity");
      cy.fillCombobox("Item Code", data.entityID);
      cy.wait(500);
      ...
      // missing "WO Type Description"
      cy.fillCombobox("Task Code", "000000");
    ...
    it.skip("should create Work Order for Item of type Entity with required fields, and then delete", () => {
      cy.get("span[ng-bind='WindowTitle']:contains('Work Order')").should(
        "be.visible"
      );
      cy.fillSelect("Item Type", "Entity");
