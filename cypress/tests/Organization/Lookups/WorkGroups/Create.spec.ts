...
describe("Create Work Group record", () => {
  beforeEach(() => {
    cy.login(Cypress.env("user1"));
    cy.visit("/#!/Lookup/Workgroup/Create");
  });

  it("Work Group - Negative Cases", { tags: "@smoke" }, () => {
  ...
  it("Create a Work Group with required fields", { tags: "@smoke" }, () => {
